    ...
    <section className="py-10 md:py-24 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-8 md:mb-16">
          <h2 className="text-2xl md:text-4xl font-bold mb-3 sm:mb-4">
            Comment ça marche ?
          </h2>
        ...
        {/* Steps */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-8 lg:gap-12 max-w-6xl mx-auto">
          {steps.map((step, index) => {
            ...
            return (
              <div key={index} className="relative">
                ...
                <Card className="relative p-4 sm:p-6 md:p-8 text-center hover:shadow-lg transition-all duration-300 bg-background border-2 hover:border-primary/50 z-10">
                  {/* Number Badge */}
                  <div className="absolute -top-3 -right-3 sm:-top-4 sm:-right-4 w-9 h-9 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-primary to-primary/80 text-primary-foreground flex items-center justify-center font-bold text-sm sm:text-lg shadow-lg">
                    {step.number}
                  </div>

                  {/* Icon */}
                  <div className={`w-14 h-14 sm:w-20 sm:h-20 mx-auto mb-4 sm:mb-6 rounded-2xl bg-gradient-to-br ${step.color} p-3 sm:p-4 shadow-lg`}>
