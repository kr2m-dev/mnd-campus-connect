        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-6xl mx-auto">
          {features.map((feature, index) => {
            ...
            return (
              <Card
                key={index}
                className="p-4 sm:p-6 hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/50 group"
              >
                {/* Icon */}
                <div className={`w-10 h-10 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-br ${feature.gradient} p-2 sm:p-3 mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300`}>
